...
export default function Events() {
  return (
    <section className="rs-event-area section-space-bottom rs-event-one bg-primary">
      <div className="container">
        <div className="row align-items-center g-5 section-title-space">
          <div className="col-xl-7 col-lg-7">
            <div className="section-title-wrapper">
              ...
              <h2 className="section-title rs-split-text-enable split-in-left has-theme-blue">Join Our Latest Events
              </h2>
            </div>
          </div>
          <div className="col-xl-5 col-lg-5">
            <div className="rs-event-btn d-flex justify-content-lg-end">
              <Link className="rs-btn has-icon has-bg-white hover-blue" href="/event">
                <span className="btn-text-wrap">
                  <span className="text-default">View More Events</span>
                  <span className="text-hover">View More Events</span>
                </span>
        ...
        <div className="row">
          <div className="col-xl-12">
            <div className="rs-event-wrapper">
              <div className="rs-event-item wow fadeIn" data-wow-delay=".3s" data-wow-duration="1s">
                <div className="rs-event-shape">
                  <img src="/assets/images/shape/three-line-shape.webp" alt="" />
                </div>
                <div className="rs-event-thumb">
                  <Link href="/event-details">
                    <img src="/assets/images/event/event-thumb-01.webp" alt="image" />
                  </Link>
                </div>
                <div className="rs-event-content">
                  <div className="rs-event-meta">
                    <span className="rs-event-meta-item">
                      <i className="ri-calendar-line"></i>August 4, 2025
                    </span>
                    <span className="rs-event-meta-item">
                      <i className="ri-time-line"></i>09:00 AM - 03:40 PM
                    </span>
                  </div>
                  <h5 className="rs-event-title">
                    <Link href="/event-details">Academic Excellence & Intellectual Development</Link>
                  </h5>
                  <span className="rs-event-meta-item">
                    <i className="ri-map-2-line"></i>MIOT, USA </span>
                </div>
              </div>
              <div className="rs-event-item wow fadeIn" data-wow-delay=".4s" data-wow-duration="1s">
                <div className="rs-event-shape">
                  <img src="/assets/images/shape/three-line-shape.webp" alt="" />
                </div>
                <div className="rs-event-thumb">
                  <Link href="/event-details">
                    <img src="/assets/images/event/event-thumb-02.webp" alt="image" />
                  </Link>
                </div>
                <div className="rs-event-content">
                  <div className="rs-event-meta">
                  ...
                  <h5 className="rs-event-title">
                    <Link href="/event-details">Innovative Research & Scientific Advancement</Link>
                  </h5>
                  <span className="rs-event-meta-item">
                    <i className="ri-map-2-line"></i>MIOT, USA </span>
                </div>
              </div>
              <div className="rs-event-item wow fadeIn" data-wow-delay=".5s" data-wow-duration="1s">
                <div className="rs-event-shape">
                  <img src="/assets/images/shape/three-line-shape.webp" alt="" />
                </div>
                <div className="rs-event-thumb">
                  <Link href="/event-details">
                    <img src="/assets/images/event/event-thumb-03.webp" alt="image" />
                  </Link>
                </div>
                <div className="rs-event-content">
                  <div className="rs-event-meta">
                  ...
                  <h5 className="rs-event-title">
                    <Link href="/event-details">Digital Transformation, Technology & Future</Link>
                  </h5>
                  <span className="rs-event-meta-item">
                    <i className="ri-map-2-line"></i>MIOT, USA </span>
                </div>
              </div>
              <div className="rs-event-item wow fadeIn" data-wow-delay=".6s" data-wow-duration="1s">
                <div className="rs-event-shape">
                  <img src="/assets/images/shape/three-line-shape.webp" alt="" />
                </div>
                <div className="rs-event-thumb">
                  <Link href="/event-details">
                    <img src="/assets/images/event/event-thumb-04.webp" alt="image" />
                  </Link>
                </div>
                <div className="rs-event-content">
                  <div className="rs-event-meta">
                  ...
                  <h5 className="rs-event-title">
                    <Link href="/event-details">Future-Ready Skills & Workforce Transformation</Link>
                  </h5>
                  <span className="rs-event-meta-item">
                    <i className="ri-map-2-line"></i>MIOT, USA </span>
                </div>
